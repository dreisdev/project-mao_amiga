    ...
    return (
        <>
            ...
            <section className="payment-boleto">
                <h1 className="payment-card-title"><FontAwesomeIcon icon={faPix} /> Pix</h1>
                ...
                <form id="payment-form" onSubmit={handleSubmit}>
                    ...
                    {loading ? (
                        <div className="loading-pix">
                            ...
                            <h1>Dados do Pix: 85-99999-9999</h1>

                            <button className="btn-back-home" >
                                <NavLink className="style-btn-back-home" to="/">Obrigado por sua doação {nameCustomer}! - Voltar para Página Inicial</NavLink>
                            </button>
                        </div>
