      ...
      <section className="history-container-about">
        <div className="content-history-about">
          <div className="row-history-a-about">
            ...
            <button className="button-history-about">
              {" "}
              <a className="button-style-about" href="/contacts">
                {" "}
                Entre em Contato{" "}
              </a>{" "}
            </button>
      ...
      <section className="container-help-us">
        <div className="help-us">
          <div className="text-help-us">
            <h2>Faça parte do nosso projeto.</h2>
          </div>

          <div>
            <button className="button-help-us">
              {" "}
              <a className="button-style-help-us" href="/">
                {" "}
                Doe Agora{" "}
              </a>{" "}
            </button>
